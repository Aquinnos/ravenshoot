...
import { getFirestore, doc, updateDoc, getDoc, collection, query, orderBy, limit, getDocs} from "https://www.gstatic.com/firebasejs/10.11.0/firebase-firestore.js";

const firebaseConfig = {
    apiKey: "AIzaSyA7COjHY9unIuzQTpk4mKY64IpiCywM3tY",
    authDomain: "point-shoot-game.firebaseapp.com",
    projectId: "point-shoot-game",
    storageBucket: "point-shoot-game.appspot.com",
    messagingSenderId: "68603130080",
    appId: "1:68603130080:web:58b672347d9b3af9482085",
    measurementId: "G-WKSEDH9XSF"
};
...
class Raven {
    constructor() {
        ...
        this.randomColors = [Math.random() * 255, Math.random() * 255, Math.random() * 255];
    ...
    if (auth.currentUser) {
        ...
        getDoc(userRef).then(docSnap => {
            if (docSnap.exists() && docSnap.data().score < score) {
                ...
                updateDoc(userRef, { score: score }).then(() => {
                ...
                setDoc(userRef, { score: score }).then(() => {
                ...
                console.log('Current score is lower than or equal to high score. No update needed.');
            }
        }).catch((error) => {
...
>>>>>>> a56c0d778b61b9927d4437adf12c2c68a7e86f99
